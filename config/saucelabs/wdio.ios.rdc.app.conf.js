...
config.capabilities = [
    {
        ...
        // testobject_api_key: '', // The api key that has a reference to the iOS app-project in the saucelabs cloud
        testobject_test_name: 'iOS sample app test', // The name of the test for in the cloud
